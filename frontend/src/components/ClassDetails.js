    ...
    <div className="container mt-3">
      ...
      <div className="row mt-3">
        ...
        <div className="left_view col-lg-4 col-md-4 col-8">
          <h3>
            Class ID: <span>{getuserdata.wardID}</span>
          </h3>
          <h3>
            Teacher Name: <span>{getuserdata.name}</span>
          </h3>
          <h3>
            Student Total: <span>{getuserdata.ICU}</span>
          </h3>
          <h3>
            Teacher ID: <span>{getuserdata.Normal}</span>
          </h3>
          <h3>
            Building: <span>{getuserdata.TotNoOfPatients}</span>
          </h3>
        </div>
      </div>
    </div>
