...
const DoctorF = () => {
  ...
  const { udata, D } = useContext(adddata);
        ...
        <div className="container">
          <div>
            <h1 className="heading1">
              Teacher<i class="fa-solid fa-user-doctor"></i>
            </h1>
          </div>
          <div className="add_btn mt-2 mb-2">
            ...
            <NavLink to="/docregister" className="btn btn-primary">
              Add data
            </NavLink>
          </div>
            ...
            <tbody>
              {getuserdata.map((element, id) => {
                return (
                  <>
                    <tr>
                      <th scope="row">{element.doctorID}</th>
                      <td>{element.name}</td>
                      <td>{element.age}</td>
                      <td>{element.gender}</td>
                      <td>{element.specialist}</td>
                      <td>{element.phoneNo}</td>
                      <td>{element.email}</td>
                      <td>{element.wardID}</td>
                      <td className="d-flex justify-content-between">
                        <NavLink to={`doctorView/${element._id}`}>
                          <button className="btn btn-success">
                            <i class="fa-solid fa-eye"></i>
                          </button>
                        </NavLink>
                        <NavLink to={`doctorEdit/${element._id}`}>
